...
namespace Mini_Pjt_Shopping.Models
{
    ...
    public partial class Final_Shopping_dbEntities : DbContext
    {
        ...
        public virtual ObjectResult<GetCartItems1_Result> GetCartItems1(Nullable<int> userid)
        {
            var useridParameter = userid.HasValue ?
                new ObjectParameter("userid", userid) :
                new ObjectParameter("userid", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetCartItems1_Result>("GetCartItems1", useridParameter);
        }
    }
}
